...
`,Qi=T`#e2e2e2`,ea={menuShadow:T`
        filter: drop-shadow(0px 5px 5px ${Qi});
        /*
...
`,L=se()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:t})=>!!t.fitContainer},styles:({hostClasses:t})=>T`
    ...
    `,renderCallback({inputs:t}){return y`
        ...
        `}}),df=[(t,e)=>e in t,(t,e)=>e in t.constructor.prototype];function ta(t,e){return t?df.some(r=>{try{return r(t,e)}catch{return!1}}):!1}function ff(t){return t.replace(/,/g,"")}var Xi;(function(t){t.Upper="upper",t.Lower="lower"})(Xi||(Xi={}));function hf(t){return typeof t=="number"?t:Number(typeof t=="string"?ff(t):t)}function es(t){const e=mf(t);if(e==null)throw new Error(`Cannot convert to a number: ${t}`);return e}function mf(t){const e=hf(t);if(!isNaN(e))return e}function Hr({max:t,min:e,value:r}){return r>t?e:r<e?t:r}var ts;(function(t){t.FirstThenWait="first-then-wait",t.AfterWait="after-wait"})(ts||(ts={}));function ra(t,e){try{return pf(t,e),!0}catch{return!1}}function pf(t,e,r){if(t.length<e)throw new Error(r?`'${r}' is not at least '${e}' in length.`:`Array is not at least '${e}' in length.`)}function wf(t){try{return JSON.parse(JSON.stringify(t))}catch(e){throw console.error("Failed to JSON copy for",t),e}}function na(){let t,e,r=!1;const n=new Promise((i,s)=>{t=o=>(r=!0,i(o)),e=o=>{r=!0,s(o)}});if(!t||!e)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${na.name}.`);return{promise:n,resolve:t,reject:e,isSettled(){return r}}}function gf(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}gf();function yf({value:t,prefix:e}){return String(t).startsWith(e)?String(t):`${e}${String(t)}`}function vf(t,e){return[t,e].filter(r=>r!==void 0).join(",")||""}function bf(t){const e=t.split(",");return ra(e,2)?{type:"2d",xCord:es(e[0]),yCord:es(e[1])}:{type:"1d"}}function Ef(t,e){Object.entries(e).forEach(([r,n])=>{k(n,"boolean")&&n?t.setAttribute(r,""):k(n,"boolean")&&!n||n==null?t.removeAttribute(r):t.setAttribute(r,String(n))})}const Tf=Xe(class extends De{constructor(t){super(t),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"lastKey",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.element=mr(t,"modifyElement")}render(t,e){return t!==this.lastKey&&(e(this.element),this.lastKey=t),G}}),Ue={name:"data-nav",selector(t){return t===""?`[${Ue.name}]`:`[${Ue.name}*="${String(t).replace(/"/g,"'")}"]`},css(t){return T`
            ${I(Ue.selector(t))}
        `}},He="nav-activated",Kr={selector:{click(t){return`${t}.${He}`},selected(t){return`${t}:focus`}},css:{click(t){return T`
            ...
            `}}},Sf={activateKeys:["Space","Return","Enter"]};function $f(){ia=wf(Sf)}let ia;$f();function rs(t){return ia.activateKeys.some(e=>{const r=e.toLowerCase();return r===t.key.toLowerCase()||r===t.code.toLowerCase()})}function Af(t,e){const r=vf(t,e);return Tf(`${t}-${e}`,n=>{const i=n.hasAttribute("tabindex")?{}:{tabindex:0},s={[Ue.name]:r,...i};Xr(n,HTMLElement),Ef(n,s),n.style.getPropertyValue("cursor")||n.style.setProperty("cursor","pointer"),n.addEventListener("mousemove",o=>{o.target===n&&n.focus()},!0),n.addEventListener("mouseleave",o=>{o.target===n&&n.blur()},!0),n.addEventListener("mousedown",o=>{o.target===n&&n.classList.add(He)},!0),n.addEventListener("mouseup",o=>{o.target===n&&n.classList.remove(He)},!0),n.addEventListener("blur",()=>{n.classList.remove(He)},!0),n.addEventListener("keydown",o=>{o.target===n&&rs(o)&&n.classList.add(He)},!0),n.addEventListener("keyup",o=>{o.target===n&&rs(o)&&n.classList.remove(He)},!0)})}function kf(t,e){return sa([],t,e)}function sa(t,e,r){return!e||e.type==="child"?!1:e.type==="1d"?ns(e.children,e,0,t,r):e.children.some((n,i)=>ns(n,e,i,t,r))}function ns(t,e,r,n,i){return t.some((s,o)=>{const a=ta(e,"isRoot")?n:n.concat(e);return i(a,s,{x:o,y:r})?!0:sa(a,s,i)})}function gr(t){if(!t)return;let e,r,n;kf(t,(s,o,a)=>o.element.matches(":focus")?(e=s,r=o,n=a,!0):!1);const i=e?(e==null?void 0:e.slice(-1)[0])||t:void 0;if(!(!r||!i||!n))return{node:r,parent:i,coords:n}}function Xt(t){t.scrollIntoView({behavior:"smooth",inline:"center",block:"center"}),t.focus()}function Mf(t){var n;if(!t)return{success:!1,reason:"no nav tree"};const e=gr(t);if(!e)return{success:!1,reason:"no focused node to enter into"};if(e.node.type==="child"||!e.node.children.length)return{success:!1,reason:"no children to enter into"};const r=e.node.type==="1d"?e.node.children[0]:(n=e.node.children[0])==null?void 0:n[0];return r?(Xt(r.element),{success:!0,defaulted:!1,wrapped:!1,newElement:r.element}):{success:!1,reason:"failed to find first child to enter into"}}function xf(t){if(!t)return{success:!1,reason:"no nav tree"};const e=gr(t);if(!e)return{success:!1,reason:"no focused node to exit out of"};if(ta(e.parent,"isRoot"))return{success:!1,reason:"at top level nav already, nothing to exit to"};const r=e.parent;return Xt(r.element),{success:!0,defaulted:!1,wrapped:!1,newElement:r.element}}function Cf(t){var r;return[...t.children,...((r=t.shadowRoot)==null?void 0:r.children)??[]]}function oa(t){const e=[];return Cf(t).forEach(r=>{if(!(r instanceof HTMLElement))return;const n=oa(r),i=r.hasAttribute(Ue.name)?bf(r.getAttribute(Ue.name)||""):void 0;if(!i){e.push(...n);return}e.push({children:n,element:r,navValue:i})}),e}function Of(t){const e=oa(t);return aa(e)}function aa(t){if(!ra(t,1))return;const e=t[0].navValue.type,r={type:e,children:[],isRoot:!0};return t.forEach(n=>{const i=n.children.length?aa(n.children):void 0,s=i?{element:n.element,children:i.children,type:i.type}:{element:n.element,type:"child"};if(n.navValue.type==="2d"&&r.type==="2d"){r.children[n.navValue.xCord]||(r.children[n.navValue.xCord]=[]);const o=r.children[n.navValue.xCord];if(o[n.navValue.yCord])throw new Error(`Parent already has child at ${n.navValue.xCord},${n.navValue.yCord}`);o[n.navValue.yCord]=s}else if(n.navValue.type==="1d"&&r.type==="1d")r.children.push(s);else if(e!==n.navValue.type){const o=new Error("child nav does not match parent nav type");throw console.error(o,n),o}}),r}function is(t,e){return t>e}function ss(t,e){return t<e}var U;(function(t){t.Up="up",t.Down="down",t.Left="left",t.Right="right"})(U||(U={}));function Lf(t,e,r){var a;if(!t)return{success:!1,reason:"no nav tree"};const n=gr(t);if(!n){const l=t.type==="1d"?t.children[0]:(a=t.children[0])==null?void 0:a[0];return l?(Xt(l.element),{success:!0,wrapped:!1,defaulted:!0,newElement:l.element}):{success:!1,reason:"no default element to focus"}}const{nextNode:i,requiresWrapping:s}=Df(n.parent,e,n),o=r?!0:!s;return(i==null?void 0:i.element)===n.node.element?{success:!1,reason:"no other nodes to navigate to"}:i&&o?(Xt(i.element),{success:!0,defaulted:!1,newElement:i.element,wrapped:s}):i?o?{success:!1,reason:"no conditions matched"}:{success:!1,reason:"not allowed to wrap"}:{success:!1,reason:"failed to find node to focus"}}function Df(t,e,r){var i,s;if(e===U.Down||e===U.Up){const o=e===U.Down?ss:is,a=e===U.Down?1:-1,l=t.type==="1d"?0:Hr({value:r.coords.y+a,min:0,max:t.children.length-1}),c=t.type==="2d"?t.children[l]:void 0,u={x:t.type==="1d"?Hr({value:r.coords.x+a,min:0,max:t.children.length-1}):c&&r.coords.x>=c.length?c.length-1:r.coords.x,y:l},d=t.type==="1d"?t.children[u.x]:(i=t.children[u.y])==null?void 0:i[u.x],f=t.type==="1d"?o(u.x,r.coords.x):o(u.y,r.coords.y);return{nextNode:d,requiresWrapping:f}}else{const o=e===U.Right?ss:is,a=e===U.Right?1:-1,l=t.type==="1d"?t.children:t.children[r.coords.y];te(l,`No current row found at y index: '${r.coords.y}'`);const c={x:Hr({value:r.coords.x+a,min:0,max:l.length-1}),y:r.coords.y},u=o(c.x,r.coords.x);return{nextNode:t.type==="1d"?t.children[c.x]:(s=t.children[c.y])==null?void 0:s[c.x],requiresWrapping:u}}}class la{constructor(e){Object.defineProperty(this,"rootElement",{enumerable:!0,configurable:!0,writable:!0,value:e})}getCurrentlyFocused(){return gr(this.buildNavTree())}buildNavTree(){return Of(this.rootElement)}navigate({direction:e,allowWrapping:r}){return Lf(this.buildNavTree(),e,r)}enterInto(){return Mf(this.buildNavTree())}exitOutOf(){return xf(this.buildNavTree())}navigatePibling(e){const r=this.exitOutOf();if(!r.success)return r;const n=this.navigate(e);if(!n.success)return n;const i=this.enterInto();return i.success?i:n}}const Nf={option:"dropdown-option"},_t=se()({tagName:"vira-dropdown-options",events:{selectionChange:we()},styles:T`
        :host {
            display: flex;
...
`,Wf=F({name:"LoaderAnimated24Icon",svgTemplate:y`
    ...
    `,events:{selectedChange:we(),openChange:we()},stateInitStatic:{showPopUpResult:void 0,popUpManager:Zo(()=>new qf),navController:void 0},cleanupCallback({state:t,updateState:e}){e({showPopUpResult:void 0}),t.popUpManager.destroy()},initCallback({state:t,updateState:e,host:r,inputs:n,dispatch:i,events:s}){t.popUpManager.listen(ca,()=>{if(e({showPopUpResult:void 0}),!n.isDisabled){const o=r.shadowRoot.querySelector(".dropdown-wrapper");Xr(o,HTMLButtonElement,"failed to find dropdown wrapper child"),o.focus()}}),t.popUpManager.listen(ua,o=>{const a=o.detail.x,l=n.options[a];if(!l)throw new Error(`Found no dropdown option at index '${a}'`);n.isMultiSelect||ls({emitEvent:!0,open:!1},{dispatch:c=>{i(new s.openChange(c))},host:r,popUpManager:t.popUpManager,updateState:e}),i(new s.selectedChange(as(l.id,n.selected,!!n.isMultiSelect)))}),e({navController:new la(r)})},renderCallback({dispatch:t,events:e,state:r,inputs:n,updateState:i,host:s}){var v;Kf(n.options);function o($){ls($,{dispatch:N=>{t(new e.openChange(N))},host:s,popUpManager:r.popUpManager,updateState:i})}n.isDisabled?o({open:!1,emitEvent:!1}):n.z_debug_forceOpenState!=null&&(!n.z_debug_forceOpenState&&r.showPopUpResult?o({emitEvent:!1,open:!1}):n.z_debug_forceOpenState&&!r.showPopUpResult&&o({emitEvent:!1,open:!0}));const a=Zf(n),l=n.icon?y`
                ...
                <div class="pop-up-positioner" style=${c}>
                    ${Se(!!r.showPopUpResult,y`
                            <${_t.assign({options:n.options,selectedOptions:a})}
                                ${x(_t.events.selectionChange,$=>{n.isMultiSelect||o({emitEvent:!0,open:!1}),t(new e.selectedChange(as($.detail.id,n.selected,!!n.isMultiSelect)))})}
                                ${ut(Ht.options)}
                            ></${_t}>
                        `)}
                </div>
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},renderCallback({inputs:t,state:e,updateState:r,dispatch:n,events:i}){const s=t.imageUrl,o=e.erroredUrls[s]?y`
        ...
        `,stateInitStatic:{forcedInputWidth:0,showPassword:!1},renderCallback:({inputs:t,dispatch:e,state:r,updateState:n,events:i})=>{const{filtered:s}=fa({value:t.value??"",allowed:t.allowedInputs,blocked:t.blockedInputs}),o=t.icon?y`
    ...
    `,renderCallback({inputs:t}){const e=Nu(t.message.time,_u.DatetimeShortWithSeconds);return y`
        ...
        `}}),us=Mn()({tagName:"vir-chat",styles:T`
        :host {
            display: flex;
            flex-direction: column;
            gap: 8px;
    ...
    `,stateInitStatic:{cleanup:void 0,connectionStatus:void 0,chatHistory:[],currentMessage:""},initCallback({inputs:t,state:e,updateState:r}){if(!e.cleanup){const n=[t.connectionController.listen(Fe,i=>{r({connectionStatus:i.detail})}),t.connectionController.listen(Cn,i=>{r({chatHistory:[...e.chatHistory,{direction:Jr.Received,time:$i(),text:i.detail}]})}),t.connectionController.listen(ha,i=>{r({chatHistory:[...e.chatHistory,{direction:Jr.Sent,time:$i(),text:i.detail}]})})];r({cleanup(){n.forEach(i=>i())}})}},cleanupCallback({state:t,updateState:e}){var r;(r=t.cleanup)==null||r.call(t),e({cleanup:void 0})},renderCallback({inputs:t,state:e,updateState:r}){var s;const n=e.chatHistory.map(o=>y`
                <${cs.assign({message:o})}></${cs}>
            ...
            <${Ae.assign({text:"send",disabled:e.connectionStatus!==le.Connected})}
                ${x("click",i)}
            ></${Ae}>
        `}}),ds=xt({tagName:"vir-how",styles:T`
        :host {
            display: block;
            max-width: 100%;
        }
    ...
    `,stateInitStatic:{connectionController:Zo(()=>new eh),connectionMode:void 0,offer:void 0,answer:void 0,connectionStatus:void 0,messageToSend:"",copied:!1,copiedTimeout:void 0,stunServerUrls:["stun.cloudflare.com:3478"]},initCallback({state:t,updateState:e}){t.connectionController.listen(Cn,r=>{console.log("message",r.detail)}),t.connectionController.listen(Fe,r=>{e({connectionStatus:r.detail}),console.log("status",r.detail)})},renderCallback({state:t,updateState:e}){const r=y`
        ...
        `;return y`
            ...
            <${us.assign({connectionController:t.connectionController})}></${us}>
        `}});
